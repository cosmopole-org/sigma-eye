...
export default function HomeNavbar() {
    ...
    return (
        <Navbar
            isBordered
            className={'bg-white dark:bg-black ' + ((!roomsListState.get({ noproxy: true }) || (homeSectionState.get({ noproxy: true }) !== 'spaces')) ? undefined : 'fixed') + " " + (homeSectionState.get({ noproxy: true }) === 'spaces' ? "h-[172px]" : "h-[128px]")}
